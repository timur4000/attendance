...
<main class="main main--type-app">

    @include(admin_directory('includes.left-navigation'))

    <section class="view">

        @include(admin_directory('includes.header'))

        <div class="view__inner view__inner--size-default">
