<div class="input-outer input-outer--theme-mercury input-outer--size-middle input-outer--type-label">
    ...
    <div class="custom-input" data-custom-input-hover>
        <input type="{{ $data['input_type'] }}" name="{{ $data['input_name'] }}" value="{{ old($data['input_name']) }}" class="input input--theme input--size-middle input-outer__input custom-input__input" placeholder=" " id="{{ $data['input_name'] }}">
