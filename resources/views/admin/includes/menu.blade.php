<section class="menu menu--size-default" id="menu">
    ...
    <ul class="menu-list">
        ...
        <li class="menu-item menu-item--size-default {{ get_is('active', \App\Standards\RouteGroups\Abstracts\RouteGroup::is_route(\App\RoutesRequests\Admin\Dashboard\DashboardIndexGetRouteRequest::class)) }}">
        ...
        <li class="menu-item menu-item--size-default {{ get_is('active', \App\Standards\RouteGroups\Abstracts\RouteGroup::is_route(\App\RoutesRequests\Admin\Users\UsersIndexGetRouteRequest::class)) }}">
        ...
        <li class="menu-item menu-item--size-default {{ get_is([ 'close', 'open' ], \App\Standards\RouteGroups\Abstracts\RouteGroup::is_route(\App\RouteGroups\Admin\Prices\PricesRouteGroup::class)) }}"
            data-menu-content>
        ...
        <li class="menu-item menu-item--size-default {{ get_is([ 'close', 'open' ], \App\Standards\RouteGroups\Abstracts\RouteGroup::is_route(\App\RouteGroups\Admin\Presence\PresenceRouteGroup::class)) }}"
            data-menu-content>
        ...
        <li class="menu-item menu-item--size-default {{ get_is([ 'close', 'open' ], \App\Standards\RouteGroups\Abstracts\RouteGroup::is_route(\App\RouteGroups\Admin\ServicesPayment\ServicesPaymentRouteGroup::class)) }}"
            data-menu-content>
        ...
        <li class="menu-item menu-item--size-default {{ get_is('active', \App\Standards\RouteGroups\Abstracts\RouteGroup::is_route(\App\RoutesRequests\Admin\ClassifierTypes\ClassifierTypesIndexGetRouteRequest::class)) }}">
        ...
        <li class="menu-item menu-item--size-default {{ get_is([ 'close', 'open' ], \App\Standards\RouteGroups\Abstracts\RouteGroup::is_route(\App\RouteGroups\Admin\Classifiers\ClassifiersRouteGroup::class)) }}"
            data-menu-content>
