    ...
    <section class="record-view">
        ...
        <div class="record-view__line grid-row">
            ...
            <div class="record-view__line-column record-view__line-column--size-default grid-column grid-column-6">
                ...
                <a href="{{ \App\Standards\RouteGroups\Abstracts\RouteGroup::get_route(\App\RoutesRequests\Admin\Permissions\AdminPermissionsPutGetRouteRequest::class, [ 'id' => $record['id'] ]) }}" class="button button--type-square button--size-middle button--theme-white-azure-wild-sand margin-right-10" data-button data-clue="Edit">
                    {!! svg('content-edit', [ 'class' => 'icon icon-size-14' ]) !!}
                </a>

                <a href="{{ \App\Standards\RouteGroups\Abstracts\RouteGroup::get_route(\App\RoutesRequests\Admin\Permissions\AdminPermissionsDeleteGetRouteRequest::class, [ 'id' => $record['id'] ]) }}" class="button button--type-square button--size-middle button--theme-white-azure-bittersweet" data-button data-is-confirm data-clue="Delete">
