...
@section('content')
    ...
    <section class="table table--size-default table--theme-mercury" id="main-table"
             data-url="{{ \App\Standards\RouteGroups\Abstracts\RouteGroup::get_route(\App\RoutesRequests\Admin\Prices\Invoices\InvoicesListJsonPostRouteRequest::class) }}"></section>


    <template data-modal-template="edit-modal">

        <form action="{{ \App\Standards\RouteGroups\Abstracts\RouteGroup::get_route(\App\RoutesRequests\Admin\Prices\Invoices\InvoicesUpdatePostRouteRequest::class) }}" method="post" class="form">
