 ...
 * @class
 *
 * @description Implements logic for the configuration types table.
 **/
export class ConfigurationTypesTable extends BaseTable
{
    /**
     * @inheritDoc
     **/
    selectors = '#configuration-types-table';
    
    /**
     * @inheritDoc
     **/
    url = 'admin/configurations/types/records-json';
        ...
        return [
            {
                ...
                buttonSettings:
                    {
                        href: 'admin/configurations/types/put',
        ...
        return [
            {
                ...
                buttonSettings:
                    {
                        href: 'admin/configurations/types/detail/{id}',
            ...
            },
            {
                ...
                buttonSettings:
                    {
                        href: 'admin/configurations/types/put/{id}',
                        iconId: 'content-edit',
            ...
            },
            {
                ...
                buttonSettings:
                    {
                        href: 'admin/configurations/types/delete/{id}',
