 ...
 * @class
 *
 * @description Implements logic for the http methods table.
 **/
export class HttpMethodsTable extends BaseTable
{
    /**
     * @inheritDoc
     **/
    selectors = '#http-methods-table';
    
    /**
     * @inheritDoc
     **/
    url = 'admin/http-methods/records-json';
        ...
        return [
            {
                ...
                buttonSettings:
                    {
                        href: 'admin/http-methods/detail/{id}',
            ...
            },
            {
                ...
                buttonSettings:
                    {
                        href: 'admin/http-methods/put/{id}',
                        iconId: 'content-edit',
            ...
            },
            {
                ...
                buttonSettings:
                    {
                        href: 'admin/http-methods/delete/{id}',
