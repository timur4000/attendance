 ...
 * @extends { ModalTable }
 *
 * @description Implements logic for the arrived on time modal table.
 **/
export class ArrivedOnTimeModalTable extends ModalTable
{
    /**
     * @inheritDoc
     **/
    modalHeading = 'Arrived on time table';
    
    /**
     * @inheritDoc
     **/
    modalId = 'arrived-on-time-modal';
    
    /**
     * @inheritDoc
     **/
    tableSelectors = '#arrived-on-time-modal-table';
    
    /**
     * @inheritDoc
     **/
    tableUrl = '/admin/presence/arrived-on-time/list_json';
    
    /**
     * @constructor
     *
     * @return { ArrivedOnTimeModalTable }
     **/
    constructor()
    {
        super();
    ...
    _getTableColumns()
    {
        return [
            ...
            { name: 'count_enter', label: 'Entries', type: TableCellTypesClassifier.STRING, isSortable: false },
            { name: 'count_exit', label: 'Exits', type: TableCellTypesClassifier.STRING, isSortable: false },
