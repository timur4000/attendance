 ...
 */
class AttendanceSummaryDataOneHourCache extends Cache
{
    public function __construct(int $hour)
    {
        $this->identifier = CacheIdentifiersClassifier::ATTENDANCE_SUMMARY_DATA_ONE_HOUR->name . CharsClassifiers::LARAVEL_DELIMITER . $hour;
    }
}
