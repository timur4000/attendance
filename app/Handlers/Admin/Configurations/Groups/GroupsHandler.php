...
namespace App\Handlers\Admin\Configurations\Groups;
...
/**
 * Implements help work with configuration groups information.
 */
class GroupsHandler extends Handler implements IGetting, IDeleting, ISelectable
{
    /**
     * Returns all records.
     *
    ...
    {
        $records = SConfigurationGroups::query();
    ...
    {
        return SConfigurationGroups::query()
            ->where('id', '=', $id)
            ->first();
    }
    ...
    {
        return SConfigurationGroups::query()->create($attributes);
    }
    ...
    {
        return SConfigurationGroups::query()->updateOrCreate($attributes, $values);
    }
