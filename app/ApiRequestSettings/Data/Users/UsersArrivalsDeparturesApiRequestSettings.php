...
/**
 * Contains all possible settings of the users arrivals and departures api request.
 */
class UsersArrivalsDeparturesApiRequestSettings extends ApiRequestSettings
{
    ...
    {
        $this->type_request = ApiRequestDataTypesClassifier::USER_ARRIVALS_AND_DEPARTURES;
