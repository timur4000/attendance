...
/**
 * Contains all possible settings of the food card cancel withdraw money api request.
 *
 * @see FoodCardSelectApiRequest
 */
class FoodCardCancelWithdrawMoneyApiRequestSettings extends ApiRequestSettings
{
    ...
    {
        $this->type_request = ApiRequestDataTypesClassifier::FOOD_CARD_CANCEL_WITHDRAW_MONEY;
    }
}
